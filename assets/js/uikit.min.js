/*! UIkit 3.6.3 | https://www.getuikit.com | (c) 2014 - 2020 YOOtheme | MIT License */ ! function(t, e) {
    ...
    function En(e, n, i) {
        var t,
            r,
            o = {};
        if ($(n) && (n = n.options), n.extends && (e = En(e, n.extends, i)), n.mixins)
    ...
    wt = {
        ...
        beforeConnect: function() {
            var t;
            this._hasTitle = ot(this.$el, "title"), rt(this.$el, "title", ""), this.updateAria(!1),
                function(t) {
